...
* Nhập URL: [https://dummyjson.com/users](https://dummyjson.com/users)
...
"firstName": "Emily",
"lastName": "Johnson",
"email": "[emily.johnson@x.dummyjson.com](mailto:emily.johnson@x.dummyjson.com)"
}
]
}
...
URL:
[https://dummyjson.com/abcdef](https://dummyjson.com/abcdef)

Các bước thực hiện:

* Mở Postman.
* Tạo request mới bằng phương thức GET.
* Nhập URL sai: [https://dummyjson.com/abcdef](https://dummyjson.com/abcdef)
* Nhấn “Send”.
...
* Tạo request mới.
* Chọn phương thức GET.
* Nhập URL: [https://dummyjson.com/products](https://dummyjson.com/products)
* Nhấn nút “Send”.
...
- Kiểm tra chính xác endpoint trước khi gửi request.
- Đối chiếu URL với tài liệu API.
- Kiểm tra phương thức HTTP phù hợp.
- Đảm bảo server và endpoint đang hoạt động bình thường.
